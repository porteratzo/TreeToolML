...
conda activate treetoolnew && cd /home/omar/Documents/mine/MY_LIBS/tictoc && pip install -e .
conda activate treetoolnew && cd /home/omar/Documents/mine/MY_LIBS/Libraries && pip install -e .
